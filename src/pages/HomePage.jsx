...
class MainHome extends React.Component {
    render() {
        return (
           ...
           {/* <center> <h1>Welcome to <span>SWARA INFRA</span></h1></center> */}
            <div className="mainhome-body">
                ...
                <section className="mainhome-container">
                    <h1 style={{fontWeight: 'bold'}} className="mainhome-title">Our <span className="mainhome-homes" style={{ color: 'blue',fontWeight: 'bold' }}>Homes</span></h1>
                    ...
                    <div className="mainhome-content">
                        <div className="mainhome-text-container">
                        ...
                        <div className="mainhome-image-container">
                            <img src={mortarImage} alt="More Than Bricks and Mortar" />
                        </div>
                    </div>
                    ...
                    <div className="mainhome-content">
                        ...
                        <div className="mainhome-image-container">
                            <img src={safetyImage} alt="Comfort and Safety" />
                        </div>
                    </div>
                    ...
                    <div className="mainhome-content">
                        ...
                        <div className="mainhome-image-container">
                            <img src={homeImage} alt="Memories and Nostalgia" />
                        </div>
                    </div>
                    ...
                    <div className="mainhome-content">
                        ...
                        <div className="mainhome-image-container">
                            <img src={personalizedImage} alt="Personalization and Expression" />
                        </div>
                    </div>

                    <div className="mainhome-content-last">
                        <p>Home isn't a static place; it's a journey that evolves with us. As we grow and change, so too does our
                            ...
                            love, comfort, and security that truly make a home.
                        </p>
                    </div>
                </section>
            </div>
