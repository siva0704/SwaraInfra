    ...
    <main>
      ...
      <section className="intro1">
        ...
        <ul>
          ...
          <li>Are you enquiring about careers at buildAhome?</li>
        </ul>
      </section>

      <div className="signupHeader">
        <h4><span>SignUp </span>for Updates</h4>
      </div>
      ...
      <section className="signup">
        <form className='form'>
          ...
          <input type="text" id="location" placeholder="Hubballi" required />


          <label htmlFor="requirements">Write your requirements</label>
          <textarea id="requirements" placeholder="Write your requirements"></textarea>
